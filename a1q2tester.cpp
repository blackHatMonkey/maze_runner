...
/*                                                                        */
/*   To compile: g++ disjointset.cpp a1q2tester.cpp a1q2.cpp -std=c++0x   */
/*                                                                        */
/*                                                                        */
/**************************************************************************/
...
int main(void){
	...
	bool result=true;
	int numPassed=0;
	for(int i=1;result && i<numTests;i++){
	...
	if(numPassed == numTests){
		std::cout << "Congratulations! You have passed testing for A1 part 2" << std::endl << std::endl;
		...
		std::cout << "    https://seneca-btp500f19.github.io/btp500-f19/" << std::endl;
...
bool test2(std::string& error){
	...
	for(int i=0;rc && i<10;i++){
		...
		if(!result){
			...
			error+= "To view the maze generated go to:\n  https://seneca-btp500f19.github.io/btp500-f19/\n";
